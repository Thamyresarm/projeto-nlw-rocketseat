...
INSERT INTO "new_Ad" ("createdAt", "discord", "gameId", "hourEnd", "hoursStart", "id", "name", "useVoiceChannel", "yearsPlaying") SELECT "createdAt", "discord", "gameId", "hourEnd", "hoursStart", "id", "name", "useVoiceChannel", "yearsPlaying" FROM "Ad";
DROP TABLE "Ad";
